        ...
        <CardContent className="p-4">
            <div className="flex justify-between items-start mb-0.5">
                <div className="space-y-0">
                    <p className="text-muted-foreground text-[14px] font-normal tracking-tight">{title}</p>
                    <h3 className="text-3xl font-normal text-foreground tracking-tight leading-tight">{value}</h3>
                </div>
                <div className="w-11 h-11 bg-secondary rounded-full flex items-center justify-center text-primary flex-shrink-0 transition-transform group-hover:scale-105">
