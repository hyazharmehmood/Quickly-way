...
import {
    ...
    MoreHorizontal, Clock, CheckCircle, XCircle, Loader2
} from 'lucide-react';
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="bg-secondary/40 hover:bg-secondary/40 border-b border-border">
                                    <TableHead className="px-6 md:px-10 py-5 text-[10px] font-normal text-muted-foreground uppercase tracking-widest">ID</TableHead>
                                    <TableHead className="px-6 md:px-10 py-5 text-[10px] font-normal text-muted-foreground uppercase tracking-widest">Request Title</TableHead>
                                    <TableHead className="px-6 md:px-10 py-5 text-[10px] font-normal text-muted-foreground uppercase tracking-widest text-center">Proposals</TableHead>
                                    ...
                                    <TableHead className="px-6 md:px-10 py-5 text-[10px] font-normal text-muted-foreground uppercase tracking-widest text-right">Budget</TableHead>
                                    <TableHead className="px-6 md:px-10 py-5 text-[10px] font-normal text-muted-foreground uppercase tracking-widest text-right">Actions</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {requests.map((req) => (
                                    <TableRow key={req.id} className="hover:bg-secondary/10 transition-colors border-b border-border group">
                                        <TableCell className="px-6 md:px-10 py-6 whitespace-nowrap font-normal text-muted-foreground text-sm">{req.id}</TableCell>
                                        <TableCell className="px-6 md:px-10 py-6">
                                            <div className="font-normal text-foreground text-base max-w-[200px] md:max-w-sm truncate">{req.title}</div>
                                        ...
                                        <TableCell className="px-6 md:px-10 py-6 whitespace-nowrap text-center">
                                            {getStatusBadge(req.status)}
                                        </TableCell>
                                        <TableCell className="px-6 md:px-10 py-6 text-right font-normal text-foreground text-sm">
                                            {req.budget}
                                        </TableCell>
